...
public abstract class AbstractFileAssert<SELF extends AbstractFileAssert<SELF>> extends AbstractAssert<SELF, File> {
  ...
  /**
   * Verifies that the actual {@code File} is executable.
   *
   * <p>
   * Example:
  ...
  /**
   * Returns {@code ByteArray} assertions on the content of the actual {@code File} read.
   * <p>
   * Example:
   ...
   *
   * @return a {@link AbstractByteArrayAssert} object with the binary content of the file.
